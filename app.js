...
const affirmations = [
    ...
    },
    {
        ...
        source: "affirmation from a Wanderer",
        author: "Alex Elle"
    },
    {
        affirmation:
            "Life is so amazing and ridiculous. It just makes you want to laugh out loud at all the things you thought would destroy you.",
        source: "twitter",
    ...
    },
    {
        ...
        source:
            "Mother Teresa's Reaching Out in Love (2002) compiled and edited by Edward Le Joly and Jaya Chaliha",
...
let getAff = (quoteList) => {
    let l = Math.floor(Math.random()* (quoteList.length - 1))
    console.log(quoteList[l].affirmation)
}
